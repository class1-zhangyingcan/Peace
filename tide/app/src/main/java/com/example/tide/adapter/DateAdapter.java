package com.example.tide.adapter;
...
public class DateAdapter extends BaseAdapter {
    ...
    public void setMonthTextView(TextView tvMonth) {
        this.tvMonth = tvMonth;
    }

    public void setSeclection(int position) {
        clickTemp = position;
        setTvMonthText(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tv.setBackgroundResource(R.drawable.top_calendar_back);
        holder.tv.getBackground().setAlpha(50);
    ...
    private void setTvMonthText(int position) {
        tvMonth.setText(getCurrentMonth(position)+"月");
    }
