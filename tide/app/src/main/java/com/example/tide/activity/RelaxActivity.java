...
import com.example.tide.utils.RenSheng;
import com.example.tide.utils.haiyang;
import com.example.tide.utils.leiyu;
import com.example.tide.utils.mingxiang;
import com.example.tide.utils.yutian;
    ...
    private void initEvents() {
        ...
        pager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                i[1] = new Intent(RelaxActivity.this, haiyang.class);
                i[2] = new Intent(RelaxActivity.this, mingxiang.class);
                i[3] = new Intent(RelaxActivity.this, leiyu.class);
                switch (currentItem) {
                    case 0:
                        item1.setImageResource(R.drawable.welcome_circle_later);
...
//                }
                ...
                i=new Intent(RelaxActivity.this,RenSheng.class);
                stopService(i);
